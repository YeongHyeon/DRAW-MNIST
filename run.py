...
def main():
    ...
    tfp.training(sess=sess, neuralnet=neuralnet, saver=saver, dataset=dataset, epochs=FLAGS.epoch, batch_size=FLAGS.batch, canvas_size=FLAGS.canvas, sequence_length=FLAGS.seqlen, print_step=10)
